...
public class ClerkJwksProvider {
    ...
    private PublicKey createPublicKey(String modules, String exponents) throws Exception {
        byte[] modulusBytes = Base64.getUrlDecoder().decode(modules);
        byte[] exponentsBytes = Base64.getUrlDecoder().decode(exponents);
