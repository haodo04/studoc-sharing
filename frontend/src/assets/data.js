import { LayoutDashboard, Upload, Files, CreditCard, Receipt, Star, Trash2, Share, Compass } from "lucide-react";
...
export const features = [
  ...
  },
  {
    ...
    description:
      "Your files are encrypt and stored securely in our cloud infrastructure.",
  },

  {
    ...
    description: "Share file with anyone using secure links that you control.",
  },
  {
    iconName: "CreditCard",
...
export const testimonials = [
  {
    ...
    quote:
      "CloudShare has transformed how our team collaborates on creative assets. The secure sharing a",
    rating: 5,
  },
  {
    name: "Michael Chen",
    ...
    quote:
      "As a freelancer, I need to share large design files with clients securely. CloudShare's simple",
    rating: 5,
  },
  {
    name: "Priya Sharma",
